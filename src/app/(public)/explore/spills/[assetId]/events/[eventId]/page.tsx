  ...
  return (
    <div className="mx-auto max-w-3xl space-y-4 py-2">
      ...
      <div className="rounded-[3px] border border-rh-line bg-rh-card px-[22px] py-4 text-[12px] text-rh-ink3">
        <strong className="text-rh-ink2">Method &amp; provenance.</strong> Dry/wet classification is decided by rainfall at the nearest EA gauge — ≤ {EA_THRESHOLD_MM} mm on the spill day and each preceding day of the window (<Link href="/explore/spills/about" className="text-rh-teal underline">how we classify</Link>).

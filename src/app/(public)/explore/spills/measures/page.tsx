  ...
  return (
    <div className="space-y-7 py-2">
      <div>
        ...
        <p className="mt-2 max-w-[640px] text-[15px] text-rh-ink2">The legally binding measures the water company must deliver in this catchment — what each requires, and what to watch.</p>
      </div>
